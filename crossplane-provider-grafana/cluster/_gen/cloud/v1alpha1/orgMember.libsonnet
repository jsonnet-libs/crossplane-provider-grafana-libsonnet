{
  ...
  '#':: d.pkg(name='orgMember', url='', help='"OrgMember is the Schema for the OrgMembers API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of OrgMember', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"OrgMemberSpec defines the desired state of OrgMember"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withOrg':: d.fn(help='"The slug or ID of the organization."', args=[d.arg(name='org', type=d.T.string)]),
      withOrg(org): { spec+: { forProvider+: { org: org } } },
      '#withReceiveBillingEmails':: d.fn(help='"Whether the user should receive billing emails."', args=[d.arg(name='receiveBillingEmails', type=d.T.boolean)]),
      withReceiveBillingEmails(receiveBillingEmails): { spec+: { forProvider+: { receiveBillingEmails: receiveBillingEmails } } },
      '#withRole':: d.fn(help='"The role to assign to the user in the organization."', args=[d.arg(name='role', type=d.T.string)]),
      withRole(role): { spec+: { forProvider+: { role: role } } },
      '#withUser':: d.fn(help="\"Username or ID of the user to add to the org's members.\"", args=[d.arg(name='user', type=d.T.string)]),
    ...
    initProvider: {
      '#withOrg':: d.fn(help='"The slug or ID of the organization."', args=[d.arg(name='org', type=d.T.string)]),
      withOrg(org): { spec+: { initProvider+: { org: org } } },
      '#withReceiveBillingEmails':: d.fn(help='"Whether the user should receive billing emails."', args=[d.arg(name='receiveBillingEmails', type=d.T.boolean)]),
      withReceiveBillingEmails(receiveBillingEmails): { spec+: { initProvider+: { receiveBillingEmails: receiveBillingEmails } } },
      '#withRole':: d.fn(help='"The role to assign to the user in the organization."', args=[d.arg(name='role', type=d.T.string)]),
