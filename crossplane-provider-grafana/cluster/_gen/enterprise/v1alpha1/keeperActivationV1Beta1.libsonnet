{
  ...
  '#':: d.pkg(name='keeperActivationV1Beta1', url='', help='"KeeperActivationV1Beta1 is the Schema for the KeeperActivationV1Beta1s API. <no value>"'),
  ...
  '#new':: d.fn(help='new returns an instance of KeeperActivationV1Beta1', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"KeeperActivationV1Beta1Spec defines the desired state of KeeperActivationV1Beta1"'),
  spec: {
