{
  ...
  spec: {
    ...
    forProvider: {
      ...
      '#grafanaSaTokenSecretRef':: d.obj(help='"(String, Sensitive) The service account token.\\nThe [service account](https://grafana.com/docs/grafana/latest/administration/service-accounts/) token."'),
      grafanaSaTokenSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { grafanaSaTokenSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { grafanaSaTokenSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { forProvider+: { grafanaSaTokenSecretRef+: { namespace: namespace } } } },
      },
      '#withGrafanaUser':: d.fn(help='"(String) The user to use for the installation.\\nThe user to use for the installation."', args=[d.arg(name='grafanaUser', type=d.T.string)]),
      withGrafanaUser(grafanaUser): { spec+: { forProvider+: { grafanaUser: grafanaUser } } },
      '#withK6ApiUrl':: d.fn(help='"(String) The Grafana Cloud k6 API url.\\nThe Grafana Cloud k6 API url."', args=[d.arg(name='k6ApiUrl', type=d.T.string)]),
      withK6ApiUrl(k6ApiUrl): { spec+: { forProvider+: { k6ApiUrl: k6ApiUrl } } },
      '#withStackId':: d.fn(help='"(String) The identifier of the stack to install k6 on.\\nThe identifier of the stack to install k6 on."', args=[d.arg(name='stackId', type=d.T.string)]),
    ...
    initProvider: {
      ...
      grafanaSaTokenSecretRef: {
        '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { grafanaSaTokenSecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { grafanaSaTokenSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { grafanaSaTokenSecretRef+: { namespace: namespace } } } },
      },
      '#withGrafanaUser':: d.fn(help='"(String) The user to use for the installation.\\nThe user to use for the installation."', args=[d.arg(name='grafanaUser', type=d.T.string)]),
      withGrafanaUser(grafanaUser): { spec+: { initProvider+: { grafanaUser: grafanaUser } } },
      '#withK6ApiUrl':: d.fn(help='"(String) The Grafana Cloud k6 API url.\\nThe Grafana Cloud k6 API url."', args=[d.arg(name='k6ApiUrl', type=d.T.string)]),
      withK6ApiUrl(k6ApiUrl): { spec+: { initProvider+: { k6ApiUrl: k6ApiUrl } } },
      '#withStackId':: d.fn(help='"(String) The identifier of the stack to install k6 on.\\nThe identifier of the stack to install k6 on."', args=[d.arg(name='stackId', type=d.T.string)]),
