{
  ...
  '#':: d.pkg(name='holiday', url='', help='"Holiday is the Schema for the Holidays API. A holiday describes time periods where a time series is expected to behave differently to normal. To use a holiday in a job, use its id in the holidays attribute of a grafana_machine_learning_job:"'),
  ...
  '#new':: d.fn(help='new returns an instance of Holiday', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"HolidaySpec defines the desired state of Holiday"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#customPeriods':: d.obj(help='"A list of custom periods for the holiday."'),
      customPeriods: {
        '#withEndTime':: d.fn(help='', args=[d.arg(name='endTime', type=d.T.string)]),
        withEndTime(endTime): { endTime: endTime },
        '#withName':: d.fn(help='"The name of the custom period."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withStartTime':: d.fn(help='', args=[d.arg(name='startTime', type=d.T.string)]),
        withStartTime(startTime): { startTime: startTime },
      },
      '#withCustomPeriods':: d.fn(help='"A list of custom periods for the holiday."', args=[d.arg(name='customPeriods', type=d.T.array)]),
      withCustomPeriods(customPeriods): { spec+: { forProvider+: { customPeriods: if std.isArray(v=customPeriods) then customPeriods else [customPeriods] } } },
      '#withCustomPeriodsMixin':: d.fn(help='"A list of custom periods for the holiday."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customPeriods', type=d.T.array)]),
      withCustomPeriodsMixin(customPeriods): { spec+: { forProvider+: { customPeriods+: if std.isArray(v=customPeriods) then customPeriods else [customPeriods] } } },
      '#withDescription':: d.fn(help='"A description of the holiday."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { forProvider+: { description: description } } },
      '#withIcalTimezone':: d.fn(help='"The timezone to use for events in the iCal file pointed to by ical_url."', args=[d.arg(name='icalTimezone', type=d.T.string)]),
      withIcalTimezone(icalTimezone): { spec+: { forProvider+: { icalTimezone: icalTimezone } } },
      '#withIcalUrl':: d.fn(help='"A URL to an iCal file containing all occurrences of the holiday."', args=[d.arg(name='icalUrl', type=d.T.string)]),
      withIcalUrl(icalUrl): { spec+: { forProvider+: { icalUrl: icalUrl } } },
      '#withName':: d.fn(help='"The name of the holiday."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withCustomPeriods':: d.fn(help='"A list of custom periods for the holiday."', args=[d.arg(name='customPeriods', type=d.T.array)]),
      withCustomPeriods(customPeriods): { spec+: { initProvider+: { customPeriods: if std.isArray(v=customPeriods) then customPeriods else [customPeriods] } } },
      '#withCustomPeriodsMixin':: d.fn(help='"A list of custom periods for the holiday."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customPeriods', type=d.T.array)]),
      withCustomPeriodsMixin(customPeriods): { spec+: { initProvider+: { customPeriods+: if std.isArray(v=customPeriods) then customPeriods else [customPeriods] } } },
      '#withDescription':: d.fn(help='"A description of the holiday."', args=[d.arg(name='description', type=d.T.string)]),
      withDescription(description): { spec+: { initProvider+: { description: description } } },
      '#withIcalTimezone':: d.fn(help='"The timezone to use for events in the iCal file pointed to by ical_url."', args=[d.arg(name='icalTimezone', type=d.T.string)]),
      withIcalTimezone(icalTimezone): { spec+: { initProvider+: { icalTimezone: icalTimezone } } },
      '#withIcalUrl':: d.fn(help='"A URL to an iCal file containing all occurrences of the holiday."', args=[d.arg(name='icalUrl', type=d.T.string)]),
      withIcalUrl(icalUrl): { spec+: { initProvider+: { icalUrl: icalUrl } } },
      '#withName':: d.fn(help='"The name of the holiday."', args=[d.arg(name='name', type=d.T.string)]),
