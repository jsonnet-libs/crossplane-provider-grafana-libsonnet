  ...
  spec: {
    ...
    forProvider: {
      ...
      metricsPublisherKeySecretRef: {
        ...
        withNamespace(namespace): { spec+: { forProvider+: { metricsPublisherKeySecretRef+: { namespace: namespace } } } },
      },
    ...
    initProvider: {
      ...
      metricsPublisherKeySecretRef: {
        ...
        '#withNamespace':: d.fn(help='"Namespace of the secret."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { initProvider+: { metricsPublisherKeySecretRef+: { namespace: namespace } } } },
      },
      '#withStackId':: d.fn(help='"(String) The ID or slug of the stack to install SM on.\\nThe ID or slug of the stack to install SM on."', args=[d.arg(name='stackId', type=d.T.string)]),
