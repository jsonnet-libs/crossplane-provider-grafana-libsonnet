{
  ...
  '#':: d.pkg(name='messageTemplate', url='', help='"MessageTemplate is the Schema for the MessageTemplates API. Manages Grafana Alerting notification template groups, including notification templates. Official documentation https://grafana.com/docs/grafana/latest/developers/http_api/alerting_provisioning/#notification-template-groups This resource requires Grafana 9.1.0 or later."'),
  ...
  '#new':: d.fn(help='new returns an instance of MessageTemplate', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'alerting.grafana.m.crossplane.io/v1alpha1',
    kind: 'MessageTemplate',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"MessageTemplateSpec defines the desired state of MessageTemplate"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withName':: d.fn(help='"(String) The name of the notification template group.\\nThe name of the notification template group."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withTemplate':: d.fn(help='"(String) The content of the notification template group.\\nThe content of the notification template group."', args=[d.arg(name='template', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withTemplate':: d.fn(help='"(String) The content of the notification template group.\\nThe content of the notification template group."', args=[d.arg(name='template', type=d.T.string)]),
      withTemplate(template): { spec+: { initProvider+: { template: template } } },
    },
