{
  ...
  '#':: d.pkg(name='suppressedAssertionsConfig', url='', help='"SuppressedAssertionsConfig is the Schema for the SuppressedAssertionsConfigs API. Manages Knowledge Graph Disabled Alert Configurations through Grafana API."'),
  ...
  '#new':: d.fn(help='new returns an instance of SuppressedAssertionsConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'asserts.grafana.m.crossplane.io/v1alpha1',
    kind: 'SuppressedAssertionsConfig',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SuppressedAssertionsConfigSpec defines the desired state of SuppressedAssertionsConfig"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withMatchLabels':: d.fn(help='"(Map of String) Labels to match for this disabled alert configuration.\\nLabels to match for this disabled alert configuration."', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabels(matchLabels): { spec+: { forProvider+: { matchLabels: matchLabels } } },
      '#withMatchLabelsMixin':: d.fn(help='"(Map of String) Labels to match for this disabled alert configuration.\\nLabels to match for this disabled alert configuration."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabelsMixin(matchLabels): { spec+: { forProvider+: { matchLabels+: matchLabels } } },
      '#withName':: d.fn(help='"(String) The name of the disabled alert configuration.\\nThe name of the disabled alert configuration."', args=[d.arg(name='name', type=d.T.string)]),
