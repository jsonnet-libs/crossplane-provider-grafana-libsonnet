{
  ...
  '#new':: d.fn(help='new returns an instance of PluginInstallation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloud.grafana.m.crossplane.io/v1alpha1',
    kind: 'PluginInstallation',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"PluginInstallationSpec defines the desired state of PluginInstallation"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withSlug':: d.fn(help='"(String) Slug of the plugin to be installed.\\nSlug of the plugin to be installed."', args=[d.arg(name='slug', type=d.T.string)]),
      withSlug(slug): { spec+: { forProvider+: { slug: slug } } },
      '#withStackSlug':: d.fn(help='"(String) The stack id to which the plugin should be installed.\\nThe stack id to which the plugin should be installed."', args=[d.arg(name='stackSlug', type=d.T.string)]),
      withStackSlug(stackSlug): { spec+: { forProvider+: { stackSlug: stackSlug } } },
      '#withVersion':: d.fn(help="\"(String) Version of the plugin to be installed. Defaults to 'latest' and installs the most recent version. Defaults to latest.\\nVersion of the plugin to be installed. Defaults to 'latest' and installs the most recent version. Defaults to `latest`.\"", args=[d.arg(name='version', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withSlug':: d.fn(help='"(String) Slug of the plugin to be installed.\\nSlug of the plugin to be installed."', args=[d.arg(name='slug', type=d.T.string)]),
      withSlug(slug): { spec+: { initProvider+: { slug: slug } } },
      '#withStackSlug':: d.fn(help='"(String) The stack id to which the plugin should be installed.\\nThe stack id to which the plugin should be installed."', args=[d.arg(name='stackSlug', type=d.T.string)]),
