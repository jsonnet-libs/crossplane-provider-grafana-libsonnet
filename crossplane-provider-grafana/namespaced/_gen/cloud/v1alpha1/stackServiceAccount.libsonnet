{
  ...
  '#new':: d.fn(help='new returns an instance of StackServiceAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloud.grafana.m.crossplane.io/v1alpha1',
    kind: 'StackServiceAccount',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"StackServiceAccountSpec defines the desired state of StackServiceAccount"'),
  spec: {
    ...
    forProvider: {
      ...
      '#withIsDisabled':: d.fn(help='"(Boolean) The disabled status for the service account. Defaults to false.\\nThe disabled status for the service account. Defaults to `false`."', args=[d.arg(name='isDisabled', type=d.T.boolean)]),
      withIsDisabled(isDisabled): { spec+: { forProvider+: { isDisabled: isDisabled } } },
      '#withName':: d.fn(help='"(String) The name of the service account.\\nThe name of the service account."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRole':: d.fn(help='"(String) The basic role of the service account in the organization.\\nThe basic role of the service account in the organization."', args=[d.arg(name='role', type=d.T.string)]),
