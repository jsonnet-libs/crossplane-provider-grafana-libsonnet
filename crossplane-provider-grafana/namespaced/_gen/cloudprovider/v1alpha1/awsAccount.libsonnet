{
  ...
  '#new':: d.fn(help='new returns an instance of AwsAccount', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudprovider.grafana.m.crossplane.io/v1alpha1',
    kind: 'AwsAccount',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AwsAccountSpec defines the desired state of AwsAccount"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#withName':: d.fn(help='"readable name for this AWS Account resource.\\nAn optional human-readable name for this AWS Account resource."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withRegions':: d.fn(help='"(Set of String) A set of regions that this AWS Account resource applies to.\\nA set of regions that this AWS Account resource applies to."', args=[d.arg(name='regions', type=d.T.array)]),
      withRegions(regions): { spec+: { forProvider+: { regions: if std.isArray(v=regions) then regions else [regions] } } },
      '#withRegionsMixin':: d.fn(help='"(Set of String) A set of regions that this AWS Account resource applies to.\\nA set of regions that this AWS Account resource applies to."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='regions', type=d.T.array)]),
      withRegionsMixin(regions): { spec+: { forProvider+: { regions+: if std.isArray(v=regions) then regions else [regions] } } },
      '#withRoleArn':: d.fn(help='"(String) An IAM Role ARN string to represent with this AWS Account resource.\\nAn IAM Role ARN string to represent with this AWS Account resource."', args=[d.arg(name='roleArn', type=d.T.string)]),
