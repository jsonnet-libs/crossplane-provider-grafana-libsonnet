{
  ...
  '#':: d.pkg(name='clusterProviderConfig', url='', help=''),
  ...
  spec: {
    ...
    '#withConnectionsApiUrl':: d.fn(help='', args=[d.arg(name='connectionsApiUrl', type=d.T.string)]),
    withConnectionsApiUrl(connectionsApiUrl): { spec+: { connectionsApiUrl: connectionsApiUrl } },
    '#withFleetManagementUrl':: d.fn(help='', args=[d.arg(name='fleetManagementUrl', type=d.T.string)]),
    withFleetManagementUrl(fleetManagementUrl): { spec+: { fleetManagementUrl: fleetManagementUrl } },
    '#withOncallUrl':: d.fn(help='', args=[d.arg(name='oncallUrl', type=d.T.string)]),
    ...
    '#withSmUrl':: d.fn(help='', args=[d.arg(name='smUrl', type=d.T.string)]),
    withSmUrl(smUrl): { spec+: { smUrl: smUrl } },
    '#withStackId':: d.fn(help='', args=[d.arg(name='stackId', type=d.T.integer)]),
