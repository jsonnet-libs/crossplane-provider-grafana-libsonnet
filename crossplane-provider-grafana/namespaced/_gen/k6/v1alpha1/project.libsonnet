{
  ...
  '#':: d.pkg(name='project', url='', help='"Project is the Schema for the Projects API. Manages a k6 project."'),
  ...
  spec: {
    ...
    forProvider: {
      '#withName':: d.fn(help='"friendly identifier of the project.\\nHuman-friendly identifier of the project."', args=[d.arg(name='name', type=d.T.string)]),
