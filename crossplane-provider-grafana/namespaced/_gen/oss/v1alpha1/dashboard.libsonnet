{
  ...
  spec: {
    ...
    forProvider: {
      '#folderRef':: d.obj(help='"Reference to a Folder in oss to populate folder."'),
      folderRef: {
      ...
      '#folderSelector':: d.obj(help='"Selector for a Folder in oss to populate folder."'),
      folderSelector: {
      ...
      '#withMessage':: d.fn(help='"(String) Set a commit message for the version history.\\nSet a commit message for the version history."', args=[d.arg(name='message', type=d.T.string)]),
      ...
      '#withOverwrite':: d.fn(help='"(Boolean) Set to true if you want to overwrite existing dashboard with newer version, same dashboard title in folder or same dashboard uid.\\nSet to true if you want to overwrite existing dashboard with newer version, same dashboard title in folder or same dashboard uid."', args=[d.arg(name='overwrite', type=d.T.boolean)]),
