{
  ...
  '#new':: d.fn(help='new returns an instance of Playlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'oss.grafana.m.crossplane.io/v1alpha1',
    kind: 'Playlist',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"PlaylistSpec defines the desired state of Playlist"'),
  spec: {
