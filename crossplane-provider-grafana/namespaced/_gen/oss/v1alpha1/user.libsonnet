{
  ...
  spec: {
    ...
    forProvider: {
      '#passwordSecretRef':: d.obj(help='"(String, Sensitive) The password for the Grafana user.\\nThe password for the Grafana user."'),
      passwordSecretRef: {
      ...
      '#withEmail':: d.fn(help='"(String) The email address of the Grafana user.\\nThe email address of the Grafana user."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withIsAdmin':: d.fn(help='"(Boolean) Whether to make user an admin. Defaults to false.\\nWhether to make user an admin. Defaults to `false`."', args=[d.arg(name='isAdmin', type=d.T.boolean)]),
      withIsAdmin(isAdmin): { spec+: { forProvider+: { isAdmin: isAdmin } } },
      '#withLogin':: d.fn(help='"(String) The username for the Grafana user.\\nThe username for the Grafana user."', args=[d.arg(name='login', type=d.T.string)]),
      withLogin(login): { spec+: { forProvider+: { login: login } } },
      '#withName':: d.fn(help='"(String) The display name for the Grafana user.\\nThe display name for the Grafana user."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    initProvider: {
      ...
      '#withIsAdmin':: d.fn(help='"(Boolean) Whether to make user an admin. Defaults to false.\\nWhether to make user an admin. Defaults to `false`."', args=[d.arg(name='isAdmin', type=d.T.boolean)]),
      withIsAdmin(isAdmin): { spec+: { initProvider+: { isAdmin: isAdmin } } },
      '#withLogin':: d.fn(help='"(String) The username for the Grafana user.\\nThe username for the Grafana user."', args=[d.arg(name='login', type=d.T.string)]),
      withLogin(login): { spec+: { initProvider+: { login: login } } },
      '#withName':: d.fn(help='"(String) The display name for the Grafana user.\\nThe display name for the Grafana user."', args=[d.arg(name='name', type=d.T.string)]),
