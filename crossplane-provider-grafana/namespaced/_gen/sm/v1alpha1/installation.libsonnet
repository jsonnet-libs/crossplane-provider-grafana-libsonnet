{
  ...
  '#spec':: d.obj(help='"InstallationSpec defines the desired state of Installation"'),
  spec: {
    '#forProvider':: d.obj(help=''),
    forProvider: {
      '#cloudStackRef':: d.obj(help='"Reference to a Stack in cloud to populate stackId."'),
      cloudStackRef: {
      ...
      '#cloudStackSelector':: d.obj(help='"Selector for a Stack in cloud to populate stackId."'),
      cloudStackSelector: {
      ...
      '#metricsPublisherKeySecretRef':: d.obj(help='"(String, Sensitive) The Grafana Cloud access policy with the following scopes: stacks:read, metrics:write, logs:write, traces:write. This is used to publish metrics and logs to Grafana Cloud stack.\\nThe [Grafana Cloud access policy](https://grafana.com/docs/grafana-cloud/security-and-account-management/authentication-and-permissions/access-policies/) with the following scopes: `stacks:read`, `metrics:write`, `logs:write`, `traces:write`. This is used to publish metrics and logs to Grafana Cloud stack."'),
      metricsPublisherKeySecretRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { forProvider+: { metricsPublisherKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { forProvider+: { metricsPublisherKeySecretRef+: { name: name } } } },
      },
      '#withStackId':: d.fn(help='"(String) The ID or slug of the stack to install SM on.\\nThe ID or slug of the stack to install SM on."', args=[d.arg(name='stackId', type=d.T.string)]),
      withStackId(stackId): { spec+: { forProvider+: { stackId: stackId } } },
      '#withStackSmApiUrl':: d.fn(help="\"cloud/testing/synthetic-monitoring/set-up/set-up-private-probes/#probe-api-server-url. A static mapping exists in the provider but it may not contain all the regions. If it does contain the stack's region, this field is computed automatically and readable.\\nThe URL of the SM API to install SM on. This depends on the stack region, find the list of API URLs here: https://grafana.com/docs/grafana-cloud/testing/synthetic-monitoring/set-up/set-up-private-probes/#probe-api-server-url. A static mapping exists in the provider but it may not contain all the regions. If it does contain the stack's region, this field is computed automatically and readable.\"", args=[d.arg(name='stackSmApiUrl', type=d.T.string)]),
      withStackSmApiUrl(stackSmApiUrl): { spec+: { forProvider+: { stackSmApiUrl: stackSmApiUrl } } },
    },
    ...
    initProvider: {
      ...
      metricsPublisherKeySecretRef: {
        '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { initProvider+: { metricsPublisherKeySecretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the secret."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { initProvider+: { metricsPublisherKeySecretRef+: { name: name } } } },
      },
      '#withStackId':: d.fn(help='"(String) The ID or slug of the stack to install SM on.\\nThe ID or slug of the stack to install SM on."', args=[d.arg(name='stackId', type=d.T.string)]),
      withStackId(stackId): { spec+: { initProvider+: { stackId: stackId } } },
      '#withStackSmApiUrl':: d.fn(help="\"cloud/testing/synthetic-monitoring/set-up/set-up-private-probes/#probe-api-server-url. A static mapping exists in the provider but it may not contain all the regions. If it does contain the stack's region, this field is computed automatically and readable.\\nThe URL of the SM API to install SM on. This depends on the stack region, find the list of API URLs here: https://grafana.com/docs/grafana-cloud/testing/synthetic-monitoring/set-up/set-up-private-probes/#probe-api-server-url. A static mapping exists in the provider but it may not contain all the regions. If it does contain the stack's region, this field is computed automatically and readable.\"", args=[d.arg(name='stackSmApiUrl', type=d.T.string)]),
      withStackSmApiUrl(stackSmApiUrl): { spec+: { initProvider+: { stackSmApiUrl: stackSmApiUrl } } },
    },
