{
  ...
  '#':: d.pkg(name='accessPolicies', url='', help='"AccessPolicies is an observe-only resource backed by the grafana_cloud_access_policies Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of AccessPolicies', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"AccessPoliciesParameters defines the input parameters for the grafana_cloud_access_policies data source."'),
    forProvider: {
      '#withNameFilter':: d.fn(help='"If set, only access policies with the specified name will be returned. This is faster than filtering in Terraform."', args=[d.arg(name='nameFilter', type=d.T.string)]),
      withNameFilter(nameFilter): { spec+: { forProvider+: { nameFilter: nameFilter } } },
      '#withRegionFilter':: d.fn(help='"If set, only access policies in the specified region will be returned. Otherwise, fetches from all available regions (more resource intensive)."', args=[d.arg(name='regionFilter', type=d.T.string)]),
