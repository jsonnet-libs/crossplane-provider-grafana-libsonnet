{
  ...
  '#':: d.pkg(name='organization', url='', help='"Organization is an observe-only resource backed by the grafana_cloud_organization Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"OrganizationParameters defines the input parameters for the grafana_cloud_organization data source."'),
    forProvider: {
      '#withSlug':: d.fn(help='"The organization slug."', args=[d.arg(name='slug', type=d.T.string)]),
