{
  ...
  '#':: d.pkg(name='privateDataSourceConnectNetworks', url='', help='"PrivateDataSourceConnectNetworks is an observe-only resource backed by the grafana_cloud_private_data_source_connect_networks Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of PrivateDataSourceConnectNetworks', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"PrivateDataSourceConnectNetworksParameters defines the input parameters for the grafana_cloud_private_data_source_connect_networks data source."'),
    forProvider: {
      '#withNameFilter':: d.fn(help='"If set, only private data source connect networks with the specified name will be returned. This is faster than filtering in Terraform."', args=[d.arg(name='nameFilter', type=d.T.string)]),
      withNameFilter(nameFilter): { spec+: { forProvider+: { nameFilter: nameFilter } } },
      '#withRegionFilter':: d.fn(help='"If set, only private data source connect networks in the specified region will be returned. This is faster than filtering in Terraform."', args=[d.arg(name='regionFilter', type=d.T.string)]),
      withRegionFilter(regionFilter): { spec+: { forProvider+: { regionFilter: regionFilter } } },
    },
