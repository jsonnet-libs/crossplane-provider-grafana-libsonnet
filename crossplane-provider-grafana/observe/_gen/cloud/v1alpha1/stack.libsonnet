{
  ...
  '#':: d.pkg(name='stack', url='', help='"Stack is an observe-only resource backed by the grafana_cloud_stack Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"StackParameters defines the input parameters for the grafana_cloud_stack data source."'),
    forProvider: {
      '#withSlug':: d.fn(help='"Subdomain that the Grafana instance will be available at (i.e. setting slug to “<stack_slug>” will make the instance\\navailable at “https://<stack_slug>.grafana.net\\"."', args=[d.arg(name='slug', type=d.T.string)]),
