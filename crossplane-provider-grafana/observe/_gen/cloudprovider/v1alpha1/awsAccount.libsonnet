{
  ...
  '#':: d.pkg(name='awsAccount', url='', help='"AwsAccount is an observe-only resource backed by the grafana_cloud_provider_aws_account Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"AwsAccountParameters defines the input parameters for the grafana_cloud_provider_aws_account data source."'),
    forProvider: {
      '#withResourceID':: d.fn(help='"The ID given by the Grafana Cloud Provider API to this AWS Account resource."', args=[d.arg(name='resourceID', type=d.T.string)]),
