{
  ...
  '#':: d.pkg(name='awsCloudwatchScrapeJob', url='', help='"AwsCloudwatchScrapeJob is an observe-only resource backed by the grafana_cloud_provider_aws_cloudwatch_scrape_job Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of AwsCloudwatchScrapeJob', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"AwsCloudwatchScrapeJobParameters defines the input parameters for the grafana_cloud_provider_aws_cloudwatch_scrape_job data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The name of the AWS CloudWatch Scrape Job. Part of the Terraform Resource ID."', args=[d.arg(name='name', type=d.T.string)]),
