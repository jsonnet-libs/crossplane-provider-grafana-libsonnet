{
  ...
  '#':: d.pkg(name='awsCloudwatchScrapeJobSet', url='', help='"AwsCloudwatchScrapeJobSet is an observe-only resource backed by the grafana_cloud_provider_aws_cloudwatch_scrape_jobs Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of AwsCloudwatchScrapeJobSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"AwsCloudwatchScrapeJobSetParameters defines the input parameters for the grafana_cloud_provider_aws_cloudwatch_scrape_jobs data source."'),
    forProvider: {
