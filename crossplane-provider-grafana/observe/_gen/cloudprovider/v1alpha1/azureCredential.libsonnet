{
  ...
  '#':: d.pkg(name='azureCredential', url='', help='"AzureCredential is an observe-only resource backed by the grafana_cloud_provider_azure_credential Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"AzureCredentialParameters defines the input parameters for the grafana_cloud_provider_azure_credential data source."'),
    forProvider: {
      '#withResourceID':: d.fn(help='"The ID given by the Grafana Cloud Provider API to this Azure Credential resource."', args=[d.arg(name='resourceID', type=d.T.string)]),
      withResourceID(resourceID): { spec+: { forProvider+: { resourceID: resourceID } } },
      '#withStackID':: d.fn(help='"The StackID of the Grafana Cloud instance. Part of the Terraform Resource ID."', args=[d.arg(name='stackID', type=d.T.string)]),
