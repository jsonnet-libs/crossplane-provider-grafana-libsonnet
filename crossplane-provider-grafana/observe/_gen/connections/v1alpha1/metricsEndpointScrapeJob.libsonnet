{
  ...
  '#':: d.pkg(name='metricsEndpointScrapeJob', url='', help='"MetricsEndpointScrapeJob is an observe-only resource backed by the grafana_connections_metrics_endpoint_scrape_job Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"MetricsEndpointScrapeJobParameters defines the input parameters for the grafana_connections_metrics_endpoint_scrape_job data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The name of the Metrics Endpoint Scrape Job. Part of the Terraform Resource ID."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withStackID':: d.fn(help='"The Stack ID of the Grafana Cloud instance. Part of the Terraform Resource ID."', args=[d.arg(name='stackID', type=d.T.string)]),
