{
  ...
  '#':: d.pkg(name='role', url='', help='"Role is an observe-only resource backed by the grafana_role Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"RoleParameters defines the input parameters for the grafana_role data source."'),
    forProvider: {
