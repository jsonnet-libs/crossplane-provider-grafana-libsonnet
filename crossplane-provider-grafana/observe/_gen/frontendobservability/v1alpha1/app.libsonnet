{
  ...
  '#':: d.pkg(name='app', url='', help='"App is an observe-only resource backed by the grafana_frontend_o11y_app Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"AppParameters defines the input parameters for the grafana_frontend_o11y_app data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The name of the Frontend Observability App. Part of the Terraform Resource ID."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withStackID':: d.fn(help='"The Stack ID of the Grafana Cloud instance. Part of the Terraform Resource ID."', args=[d.arg(name='stackID', type=d.T.integer)]),
