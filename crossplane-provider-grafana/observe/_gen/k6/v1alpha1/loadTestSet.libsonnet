{
  ...
  '#':: d.pkg(name='loadTestSet', url='', help='"LoadTestSet is an observe-only resource backed by the grafana_k6_load_tests Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of LoadTestSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"LoadTestSetParameters defines the input parameters for the grafana_k6_load_tests data source."'),
    forProvider: {
      '#withName':: d.fn(help='"Human-friendly identifier of the load test."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withProjectID':: d.fn(help='"The identifier of the project the load tests belong to."', args=[d.arg(name='projectID', type=d.T.string)]),
