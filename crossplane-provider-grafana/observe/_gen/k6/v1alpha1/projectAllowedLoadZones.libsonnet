{
  ...
  '#':: d.pkg(name='projectAllowedLoadZones', url='', help='"ProjectAllowedLoadZones is an observe-only resource backed by the grafana_k6_project_allowed_load_zones Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectAllowedLoadZones', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ProjectAllowedLoadZonesParameters defines the input parameters for the grafana_k6_project_allowed_load_zones data source."'),
    forProvider: {
      '#withProjectID':: d.fn(help='"The identifier of the project to retrieve private allowed load zones for."', args=[d.arg(name='projectID', type=d.T.string)]),
