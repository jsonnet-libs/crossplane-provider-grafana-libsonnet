{
  ...
  '#':: d.pkg(name='projectLimits', url='', help='"ProjectLimits is an observe-only resource backed by the grafana_k6_project_limits Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ProjectLimitsParameters defines the input parameters for the grafana_k6_project_limits data source."'),
    forProvider: {
      '#withProjectID':: d.fn(help='"The identifier of the project to get limits for."', args=[d.arg(name='projectID', type=d.T.string)]),
