{
  ...
  '#':: d.pkg(name='projectSet', url='', help='"ProjectSet is an observe-only resource backed by the grafana_k6_projects Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ProjectSetParameters defines the input parameters for the grafana_k6_projects data source."'),
    forProvider: {
      '#withName':: d.fn(help='"Human-friendly identifier of the project."', args=[d.arg(name='name', type=d.T.string)]),
