{
  ...
  '#':: d.pkg(name='schedule', url='', help='"Schedule is an observe-only resource backed by the grafana_k6_schedule Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ScheduleParameters defines the input parameters for the grafana_k6_schedule data source."'),
    forProvider: {
      '#withLoadTestID':: d.fn(help='"The identifier of the load test to retrieve the schedule for."', args=[d.arg(name='loadTestID', type=d.T.string)]),
