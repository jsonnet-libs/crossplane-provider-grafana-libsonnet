{
  ...
  '#':: d.pkg(name='escalationChain', url='', help='"EscalationChain is an observe-only resource backed by the grafana_oncall_escalation_chain Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"EscalationChainParameters defines the input parameters for the grafana_oncall_escalation_chain data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The escalation chain name."', args=[d.arg(name='name', type=d.T.string)]),
