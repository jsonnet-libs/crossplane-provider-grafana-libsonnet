{
  ...
  '#':: d.pkg(name='label', url='', help='"Label is an observe-only resource backed by the grafana_oncall_label Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of Label', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"LabelParameters defines the input parameters for the grafana_oncall_label data source."'),
    forProvider: {
      '#withKey':: d.fn(help='"The key for the label."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { spec+: { forProvider+: { key: key } } },
      '#withValue':: d.fn(help='"The value of the label."', args=[d.arg(name='value', type=d.T.string)]),
