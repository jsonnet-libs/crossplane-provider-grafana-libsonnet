{
  ...
  '#':: d.pkg(name='outgoingWebhook', url='', help='"OutgoingWebhook is an observe-only resource backed by the grafana_oncall_outgoing_webhook Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"OutgoingWebhookParameters defines the input parameters for the grafana_oncall_outgoing_webhook data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The outgoing webhook name."', args=[d.arg(name='name', type=d.T.string)]),
