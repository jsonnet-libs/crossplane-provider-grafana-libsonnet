{
  ...
  '#':: d.pkg(name='schedule', url='', help='"Schedule is an observe-only resource backed by the grafana_oncall_schedule Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ScheduleParameters defines the input parameters for the grafana_oncall_schedule data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The schedule name."', args=[d.arg(name='name', type=d.T.string)]),
