{
  ...
  '#':: d.pkg(name='slackChannel', url='', help='"SlackChannel is an observe-only resource backed by the grafana_oncall_slack_channel Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of SlackChannel', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"SlackChannelParameters defines the input parameters for the grafana_oncall_slack_channel data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The Slack channel name."', args=[d.arg(name='name', type=d.T.string)]),
