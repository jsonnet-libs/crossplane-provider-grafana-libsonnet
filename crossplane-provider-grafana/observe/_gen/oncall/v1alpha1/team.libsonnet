{
  ...
  '#':: d.pkg(name='team', url='', help='"Team is an observe-only resource backed by the grafana_oncall_team Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"TeamParameters defines the input parameters for the grafana_oncall_team data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The team name."', args=[d.arg(name='name', type=d.T.string)]),
