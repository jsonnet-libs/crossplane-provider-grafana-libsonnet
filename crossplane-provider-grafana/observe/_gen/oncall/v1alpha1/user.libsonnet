{
  ...
  '#':: d.pkg(name='user', url='', help='"User is an observe-only resource backed by the grafana_oncall_user Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"UserParameters defines the input parameters for the grafana_oncall_user data source."'),
    forProvider: {
