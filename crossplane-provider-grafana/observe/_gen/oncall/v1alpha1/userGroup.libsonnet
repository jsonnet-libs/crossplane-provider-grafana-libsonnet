{
  ...
  '#':: d.pkg(name='userGroup', url='', help='"UserGroup is an observe-only resource backed by the grafana_oncall_user_group Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"UserGroupParameters defines the input parameters for the grafana_oncall_user_group data source."'),
    forProvider: {
      '#withSlackHandle':: d.fn(help='', args=[d.arg(name='slackHandle', type=d.T.string)]),
      withSlackHandle(slackHandle): { spec+: { forProvider+: { slackHandle: slackHandle } } },
    },
