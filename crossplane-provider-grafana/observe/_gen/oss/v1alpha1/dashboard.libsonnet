{
  ...
  '#':: d.pkg(name='dashboard', url='', help='"Dashboard is an observe-only resource backed by the grafana_dashboard Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"DashboardParameters defines the input parameters for the grafana_dashboard data source."'),
    forProvider: {
      '#withDashboardID':: d.fn(help='"The numerical ID of the Grafana dashboard. Specify either this or `uid`."', args=[d.arg(name='dashboardID', type=d.T.integer)]),
      withDashboardID(dashboardID): { spec+: { forProvider+: { dashboardID: dashboardID } } },
      ...
      '#withUid':: d.fn(help='"The uid of the Grafana dashboard. Specify either this or `dashboard_id`."', args=[d.arg(name='uid', type=d.T.string)]),
