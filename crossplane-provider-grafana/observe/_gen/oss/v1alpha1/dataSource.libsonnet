{
  ...
  '#':: d.pkg(name='dataSource', url='', help='"DataSource is an observe-only resource backed by the grafana_data_source Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"DataSourceParameters defines the input parameters for the grafana_data_source data source."'),
    forProvider: {
