{
  ...
  '#':: d.pkg(name='folder', url='', help='"Folder is an observe-only resource backed by the grafana_folder Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"FolderParameters defines the input parameters for the grafana_folder data source."'),
    forProvider: {
      ...
      '#withTitle':: d.fn(help='"The title of the folder. If not set, only the uid is used to find the folder."', args=[d.arg(name='title', type=d.T.string)]),
      withTitle(title): { spec+: { forProvider+: { title: title } } },
      '#withUid':: d.fn(help='"The uid of the folder. If not set, only the title of the folder is used to find the folder."', args=[d.arg(name='uid', type=d.T.string)]),
