{
  ...
  '#':: d.pkg(name='folderSet', url='', help='"FolderSet is an observe-only resource backed by the grafana_folders Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of FolderSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"FolderSetParameters defines the input parameters for the grafana_folders data source."'),
    forProvider: {
