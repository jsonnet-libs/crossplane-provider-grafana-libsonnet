{
  ...
  '#':: d.pkg(name='libraryPanel', url='', help='"LibraryPanel is an observe-only resource backed by the grafana_library_panel Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"LibraryPanelParameters defines the input parameters for the grafana_library_panel data source."'),
    forProvider: {
      '#withName':: d.fn(help='"Name of the library panel."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withUid':: d.fn(help='"The unique identifier (UID) of the library panel."', args=[d.arg(name='uid', type=d.T.string)]),
