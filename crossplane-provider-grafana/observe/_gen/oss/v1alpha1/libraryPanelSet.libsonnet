{
  ...
  '#':: d.pkg(name='libraryPanelSet', url='', help='"LibraryPanelSet is an observe-only resource backed by the grafana_library_panels Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of LibraryPanelSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"LibraryPanelSetParameters defines the input parameters for the grafana_library_panels data source."'),
    forProvider: {
