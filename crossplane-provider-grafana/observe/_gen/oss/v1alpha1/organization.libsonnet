{
  ...
  '#':: d.pkg(name='organization', url='', help='"Organization is an observe-only resource backed by the grafana_organization Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"OrganizationParameters defines the input parameters for the grafana_organization data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The name of the Organization."', args=[d.arg(name='name', type=d.T.string)]),
