{
  ...
  '#':: d.pkg(name='organizationPreferences', url='', help='"OrganizationPreferences is an observe-only resource backed by the grafana_organization_preferences Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"OrganizationPreferencesParameters defines the input parameters for the grafana_organization_preferences data source."'),
    forProvider: {
