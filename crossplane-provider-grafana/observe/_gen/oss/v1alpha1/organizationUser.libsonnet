{
  ...
  '#':: d.pkg(name='organizationUser', url='', help='"OrganizationUser is an observe-only resource backed by the grafana_organization_user Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of OrganizationUser', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"OrganizationUserParameters defines the input parameters for the grafana_organization_user data source."'),
    forProvider: {
      '#withEmail':: d.fn(help='"The email address of the Grafana user."', args=[d.arg(name='email', type=d.T.string)]),
      withEmail(email): { spec+: { forProvider+: { email: email } } },
      '#withLogin':: d.fn(help='"The username of the Grafana user."', args=[d.arg(name='login', type=d.T.string)]),
