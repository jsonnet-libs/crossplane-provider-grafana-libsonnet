{
  ...
  '#':: d.pkg(name='serviceAccount', url='', help='"ServiceAccount is an observe-only resource backed by the grafana_service_account Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ServiceAccountParameters defines the input parameters for the grafana_service_account data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The name of the Service Account."', args=[d.arg(name='name', type=d.T.string)]),
