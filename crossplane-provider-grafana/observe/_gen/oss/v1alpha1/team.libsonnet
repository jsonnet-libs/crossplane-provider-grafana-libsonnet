{
  ...
  '#':: d.pkg(name='team', url='', help='"Team is an observe-only resource backed by the grafana_team Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"TeamParameters defines the input parameters for the grafana_team data source."'),
    forProvider: {
      '#withName':: d.fn(help='"The name of the Grafana team."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { spec+: { forProvider+: { name: name } } },
      '#withOrgID':: d.fn(help='"The Organization ID. If not set, the default organization is used for basic authentication, or the one that owns your service account for token authentication."', args=[d.arg(name='orgID', type=d.T.string)]),
      withOrgID(orgID): { spec+: { forProvider+: { orgID: orgID } } },
      '#withReadTeamSync':: d.fn(help='"Whether to read the team sync settings. This is only available in Grafana Enterprise."', args=[d.arg(name='readTeamSync', type=d.T.boolean)]),
      withReadTeamSync(readTeamSync): { spec+: { forProvider+: { readTeamSync: readTeamSync } } },
    },
