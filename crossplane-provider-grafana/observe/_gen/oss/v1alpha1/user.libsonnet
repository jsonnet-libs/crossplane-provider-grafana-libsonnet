{
  ...
  '#':: d.pkg(name='user', url='', help='"User is an observe-only resource backed by the grafana_user Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"UserParameters defines the input parameters for the grafana_user data source."'),
    forProvider: {
      ...
      '#withLogin':: d.fn(help='"The username for the Grafana user."', args=[d.arg(name='login', type=d.T.string)]),
      withLogin(login): { spec+: { forProvider+: { login: login } } },
      '#withUserID':: d.fn(help='"The numerical ID of the Grafana user."', args=[d.arg(name='userID', type=d.T.integer)]),
