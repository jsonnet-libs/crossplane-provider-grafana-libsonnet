{
  ...
  '#':: d.pkg(name='probe', url='', help='"Probe is an observe-only resource backed by the grafana_synthetic_monitoring_probe Terraform data source."'),
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ProbeParameters defines the input parameters for the grafana_synthetic_monitoring_probe data source."'),
    forProvider: {
      '#withName':: d.fn(help='"Name of the probe."', args=[d.arg(name='name', type=d.T.string)]),
