{
  ...
  '#':: d.pkg(name='probeSet', url='', help='"ProbeSet is an observe-only resource backed by the grafana_synthetic_monitoring_probes Terraform data source."'),
  ...
  '#new':: d.fn(help='new returns an instance of ProbeSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help=''),
  spec: {
    '#forProvider':: d.obj(help='"ProbeSetParameters defines the input parameters for the grafana_synthetic_monitoring_probes data source."'),
    forProvider: {
      '#withFilterDeprecated':: d.fn(help='"If true, only probes that are not deprecated will be returned. Defaults to `true`."', args=[d.arg(name='filterDeprecated', type=d.T.boolean)]),
      withFilterDeprecated(filterDeprecated): { spec+: { forProvider+: { filterDeprecated: filterDeprecated } } },
    },
