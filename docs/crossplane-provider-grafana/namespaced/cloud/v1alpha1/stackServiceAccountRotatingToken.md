---
permalink: /crossplane-provider-grafana/namespaced/cloud/v1alpha1/stackServiceAccountRotatingToken/
---

# cloud.v1alpha1.stackServiceAccountRotatingToken
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withDeleteOnDestroy(deleteOnDestroy)`](#fn-specforproviderwithdeleteondestroy)
    * [`fn withEarlyRotationWindowSeconds(earlyRotationWindowSeconds)`](#fn-specforproviderwithearlyrotationwindowseconds)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withDeleteOnDestroy(deleteOnDestroy)`](#fn-specinitproviderwithdeleteondestroy)
    * [`fn withEarlyRotationWindowSeconds(earlyRotationWindowSeconds)`](#fn-specinitproviderwithearlyrotationwindowseconds)
...
new returns an instance of StackServiceAccountRotatingToken
...
### fn spec.forProvider.withDeleteOnDestroy

```ts
withDeleteOnDestroy(deleteOnDestroy)
```
...
### fn spec.forProvider.withEarlyRotationWindowSeconds

```ts
withEarlyRotationWindowSeconds(earlyRotationWindowSeconds)
```
...
### fn spec.initProvider.withDeleteOnDestroy
...
### fn spec.initProvider.withEarlyRotationWindowSeconds
