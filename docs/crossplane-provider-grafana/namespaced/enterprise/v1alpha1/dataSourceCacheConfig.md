---
permalink: /crossplane-provider-grafana/namespaced/enterprise/v1alpha1/dataSourceCacheConfig/
---

# enterprise.v1alpha1.dataSourceCacheConfig
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withTtlQueriesMs(ttlQueriesMs)`](#fn-specforproviderwithttlqueriesms)
    * [`fn withTtlResourcesMs(ttlResourcesMs)`](#fn-specforproviderwithttlresourcesms)
    * [`fn withUseDefaultTtl(useDefaultTtl)`](#fn-specforproviderwithusedefaultttl)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withTtlQueriesMs(ttlQueriesMs)`](#fn-specinitproviderwithttlqueriesms)
    * [`fn withTtlResourcesMs(ttlResourcesMs)`](#fn-specinitproviderwithttlresourcesms)
    * [`fn withUseDefaultTtl(useDefaultTtl)`](#fn-specinitproviderwithusedefaultttl)
...
new returns an instance of DataSourceCacheConfig
...
### fn spec.forProvider.withTtlQueriesMs

```ts
withTtlQueriesMs(ttlQueriesMs)
```
...
### fn spec.forProvider.withTtlResourcesMs

```ts
withTtlResourcesMs(ttlResourcesMs)
```
...
### fn spec.forProvider.withUseDefaultTtl

```ts
withUseDefaultTtl(useDefaultTtl)
```
...
### fn spec.initProvider.withTtlQueriesMs
...
### fn spec.initProvider.withTtlResourcesMs
...
### fn spec.initProvider.withUseDefaultTtl
