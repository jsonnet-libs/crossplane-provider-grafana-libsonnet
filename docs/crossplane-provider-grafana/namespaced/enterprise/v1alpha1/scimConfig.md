---
permalink: /crossplane-provider-grafana/namespaced/enterprise/v1alpha1/scimConfig/
---

# enterprise.v1alpha1.scimConfig
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withEnableGroupSync(enableGroupSync)`](#fn-specforproviderwithenablegroupsync)
    * [`fn withEnableUserSync(enableUserSync)`](#fn-specforproviderwithenableusersync)
    * [`fn withOrgId(orgId)`](#fn-specforproviderwithorgid)
    * [`fn withRejectNonProvisionedUsers(rejectNonProvisionedUsers)`](#fn-specforproviderwithrejectnonprovisionedusers)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withEnableGroupSync(enableGroupSync)`](#fn-specinitproviderwithenablegroupsync)
    * [`fn withEnableUserSync(enableUserSync)`](#fn-specinitproviderwithenableusersync)
    * [`fn withOrgId(orgId)`](#fn-specinitproviderwithorgid)
    * [`fn withRejectNonProvisionedUsers(rejectNonProvisionedUsers)`](#fn-specinitproviderwithrejectnonprovisionedusers)
...
new returns an instance of ScimConfig
...
### fn spec.forProvider.withEnableGroupSync

```ts
withEnableGroupSync(enableGroupSync)
```

"(Boolean) Whether group synchronization is enabled.\nWhether group synchronization is enabled."

### fn spec.forProvider.withEnableUserSync

```ts
withEnableUserSync(enableUserSync)
```
...
### fn spec.forProvider.withRejectNonProvisionedUsers

```ts
withRejectNonProvisionedUsers(rejectNonProvisionedUsers)
```
...
### fn spec.initProvider.withEnableGroupSync
...
### fn spec.initProvider.withEnableUserSync
...
### fn spec.initProvider.withRejectNonProvisionedUsers
