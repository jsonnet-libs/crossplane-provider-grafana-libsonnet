---
permalink: /crossplane-provider-grafana/namespaced/grafana/v1beta1/clusterProviderConfig/
---

# grafana.v1beta1.clusterProviderConfig
...
* [`obj spec`](#obj-spec)
  * [`fn withCloudApiUrl(cloudApiUrl)`](#fn-specwithcloudapiurl)
  * [`fn withCloudProviderUrl(cloudProviderUrl)`](#fn-specwithcloudproviderurl)
  * [`fn withConnectionsApiUrl(connectionsApiUrl)`](#fn-specwithconnectionsapiurl)
  * [`fn withFleetManagementUrl(fleetManagementUrl)`](#fn-specwithfleetmanagementurl)
  * [`fn withOncallUrl(oncallUrl)`](#fn-specwithoncallurl)
  * [`fn withOrgId(orgId)`](#fn-specwithorgid)
  * [`fn withSmUrl(smUrl)`](#fn-specwithsmurl)
  * [`fn withStackId(stackId)`](#fn-specwithstackid)
...
```ts
withCloudProviderUrl(cloudProviderUrl)
```
...
```ts
withConnectionsApiUrl(connectionsApiUrl)
```
...
```ts
withFleetManagementUrl(fleetManagementUrl)
```
