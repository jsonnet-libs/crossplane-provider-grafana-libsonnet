---
permalink: /crossplane-provider-grafana/namespaced/k6/v1alpha1/loadTest/
---

# k6.v1alpha1.loadTest
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withBaselineTestRunId(baselineTestRunId)`](#fn-specforproviderwithbaselinetestrunid)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    * [`fn withBaselineTestRunId(baselineTestRunId)`](#fn-specinitproviderwithbaselinetestrunid)
...
new returns an instance of LoadTest
...
### fn spec.forProvider.withBaselineTestRunId

```ts
withBaselineTestRunId(baselineTestRunId)
```
...
### fn spec.initProvider.withBaselineTestRunId
