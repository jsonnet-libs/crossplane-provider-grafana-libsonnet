---
permalink: /crossplane-provider-grafana/namespaced/oncall/v1alpha1/outgoingWebhook/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    ...
    * [`fn withForwardWholePayload(forwardWholePayload)`](#fn-specforproviderwithforwardwholepayload)
    * [`fn withHeaders(headers)`](#fn-specforproviderwithheaders)
    ...
    * [`fn withTriggerType(triggerType)`](#fn-specforproviderwithtriggertype)
    * [`fn withUrl(url)`](#fn-specforproviderwithurl)
    * [`fn withUser(user)`](#fn-specforproviderwithuser)
    * [`obj spec.forProvider.authorizationHeaderSecretRef`](#obj-specforproviderauthorizationheadersecretref)
    ...
    * [`obj spec.forProvider.integrationFilterRef`](#obj-specforproviderintegrationfilterref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specforproviderintegrationfilterrefwithnamespace)
    ...
    * [`obj spec.forProvider.integrationFilterSelector`](#obj-specforproviderintegrationfilterselector)
      ...
      * [`fn withNamespace(namespace)`](#fn-specforproviderintegrationfilterselectorwithnamespace)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withHeaders(headers)`](#fn-specinitproviderwithheaders)
    ...
    * [`fn withTriggerType(triggerType)`](#fn-specinitproviderwithtriggertype)
    * [`fn withUrl(url)`](#fn-specinitproviderwithurl)
    * [`fn withUser(user)`](#fn-specinitproviderwithuser)
    * [`obj spec.initProvider.authorizationHeaderSecretRef`](#obj-specinitproviderauthorizationheadersecretref)
    ...
    * [`obj spec.initProvider.integrationFilterRef`](#obj-specinitproviderintegrationfilterref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitproviderintegrationfilterrefwithnamespace)
    ...
    * [`obj spec.initProvider.integrationFilterSelector`](#obj-specinitproviderintegrationfilterselector)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitproviderintegrationfilterselectorwithnamespace)
...
new returns an instance of OutgoingWebhook
...
### fn spec.forProvider.withForwardWholePayload

```ts
withForwardWholePayload(forwardWholePayload)
```
...
### fn spec.forProvider.withHeaders
...
### fn spec.forProvider.withIntegrationFilter

```ts
withIntegrationFilter(integrationFilter)
```
...
### fn spec.forProvider.withIntegrationFilterMixin

```ts
withIntegrationFilterMixin(integrationFilter)
```
...
```ts
withIsWebhookEnabled(isWebhookEnabled)
```
...
### fn spec.forProvider.withPreset
...
### fn spec.forProvider.withTriggerType
...
## obj spec.forProvider.authorizationHeaderSecretRef
...
### fn spec.forProvider.authorizationHeaderSecretRef.withKey
...
### fn spec.forProvider.authorizationHeaderSecretRef.withName
...
### fn spec.forProvider.integrationFilterRef.withNamespace
...
### fn spec.forProvider.integrationFilterSelector.withNamespace
...
### fn spec.initProvider.withForwardWholePayload
...
### fn spec.initProvider.withHeaders
...
### fn spec.initProvider.withIntegrationFilter
...
### fn spec.initProvider.withIntegrationFilterMixin
...
### fn spec.initProvider.withIsWebhookEnabled
...
### fn spec.initProvider.withPreset
...
### fn spec.initProvider.withTriggerType
...
## obj spec.initProvider.authorizationHeaderSecretRef

"(String, Sensitive) The auth data of the webhook. Used in Authorization header instead of user/password auth.\nThe auth data of the webhook. Used in Authorization header instead of user/password auth."

### fn spec.initProvider.authorizationHeaderSecretRef.withKey
...
### fn spec.initProvider.authorizationHeaderSecretRef.withName
...
### fn spec.initProvider.integrationFilterRef.withNamespace
...
### fn spec.initProvider.integrationFilterSelector.withNamespace
