---
permalink: /crossplane-provider-grafana/namespaced/sm/v1alpha1/checkAlerts/
---

# sm.v1alpha1.checkAlerts
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.forProvider`](#obj-specforprovider)
    * [`fn withAlerts(alerts)`](#fn-specforproviderwithalerts)
    * [`fn withAlertsMixin(alerts)`](#fn-specforproviderwithalertsmixin)
    * [`fn withCheckId(checkId)`](#fn-specforproviderwithcheckid)
    * [`obj spec.forProvider.alerts`](#obj-specforprovideralerts)
      * [`fn withName(name)`](#fn-specforprovideralertswithname)
    ...
    * [`obj spec.forProvider.checkRef`](#obj-specforprovidercheckref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specforprovidercheckrefwithnamespace)
    ...
    * [`obj spec.forProvider.checkSelector`](#obj-specforprovidercheckselector)
      ...
      * [`fn withNamespace(namespace)`](#fn-specforprovidercheckselectorwithnamespace)
  ...
  * [`obj spec.initProvider`](#obj-specinitprovider)
    ...
    * [`fn withCheckId(checkId)`](#fn-specinitproviderwithcheckid)
    * [`obj spec.initProvider.alerts`](#obj-specinitprovideralerts)
      * [`fn withName(name)`](#fn-specinitprovideralertswithname)
    ...
    * [`obj spec.initProvider.checkRef`](#obj-specinitprovidercheckref)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitprovidercheckrefwithnamespace)
    ...
    * [`obj spec.initProvider.checkSelector`](#obj-specinitprovidercheckselector)
      ...
      * [`fn withNamespace(namespace)`](#fn-specinitprovidercheckselectorwithnamespace)
...
new returns an instance of CheckAlerts
...
### fn spec.forProvider.withAlerts
...
### fn spec.forProvider.withAlertsMixin
...
### fn spec.forProvider.withCheckId
...
## obj spec.forProvider.alerts

"(Set of Object) List of alerts for the check. (see below for nested schema)\nList of alerts for the check."

### fn spec.forProvider.alerts.withName
...
### fn spec.forProvider.alerts.withPeriod
...
### fn spec.forProvider.alerts.withRunbookUrl
...
### fn spec.forProvider.alerts.withThreshold
...
### fn spec.forProvider.checkRef.withNamespace
...
### fn spec.forProvider.checkSelector.withNamespace
...
### fn spec.initProvider.withAlerts
...
### fn spec.initProvider.withAlertsMixin
...
### fn spec.initProvider.withCheckId
...
## obj spec.initProvider.alerts

"(Set of Object) List of alerts for the check. (see below for nested schema)\nList of alerts for the check."

### fn spec.initProvider.alerts.withName
...
### fn spec.initProvider.alerts.withPeriod
...
### fn spec.initProvider.alerts.withRunbookUrl
...
### fn spec.initProvider.alerts.withThreshold
...
### fn spec.initProvider.checkRef.withNamespace
...
### fn spec.initProvider.checkSelector.withNamespace
